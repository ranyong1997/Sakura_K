...
#         self.db = db
#         self.model = dict_type_model.DictTypeModel
#         self.schema = dict_schema.DictDetailsSimpleOut
#
#
...
#         self.db = db
#         self.model = settings_model.Settings
#         self.schema = settings_schema.SettingsSimpleOut
#
...
#
#     def __init__(self, db: AsyncSession):
#         super(SettingsTabDal, self).__init__(
#             db,
#             settings_table_model.SettingsTableModel,
#             settings_tab_schema.SettingsTabSimpleOut
#         )
#
...
#         获取系统配置分类下的标签信息
#         """
#         model = settings_table_model.SettingsTableModel
...
#
#     @classmethod
#     def __generate_values(cls, datas: list[settings_table_model.SettingsTableModel]) -> dict:
#         """
#         生成字典值
#         """
#         return {
...
#
#
# class TaskDal(MongoCrud):
#     class JobOperation(Enum):
#         add = "add_job"
#
#     def __init__(self, db: AsyncIOMotorDatabase):
#         super(TaskDal, self).__init__(db, "vadmin_system_task", task_schema.TaskSimpleOut)
#
#     async def get_task(
#             self,
#             _id: str = None,
...
#             }
#         }
#         return await rd.publish(settings.settings.task.SCHEDULER_TASK_JOBS, json.dumps(message).encode('utf-8'))
#
#     async def create_task(self, rd: Redis, data: task_schema.Task) -> dict:
#         """
#         创建任务
#         """
...
#         obj = await self.get_task(insert_result.inserted_id, v_schema=task_schema.TaskSimpleOut)
#
#         # 如果分组不存在则新增分组
...
#         return result
#
#     async def put_task(self, rd: Redis, _id: str, data: task_schema.Task) -> dict:
#         """
#         更新任务
#         """
#         data_dict = data.model_dump()
...
#         obj: dict = await self.get_task(_id, v_schema=task_schema.TaskSimpleOut)
#
#         # 如果分组不存在则新增分组
#         group = await TaskGroupDal(self.db).get_data(value=data.group, v_return_none=True)
#         if not group:
...
#         执行一次任务
#         """
#         obj: dict = await self.get_data(_id, v_schema=task_schema.TaskSimpleOut)
#         message = {
#             "operation": self.JobOperation.add.value,
#             "task": {
#                 "exec_strategy": "once",
