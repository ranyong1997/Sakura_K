...
from apps.models.auth_user_to_role_model import auth_user_roles_model, auth_user_depts_model
...
class UserModel(AbstractORMModel):
    __tablename__ = "user"
    ...
    roles: Mapped[set["RoleModel"]] = relationship(secondary=auth_user_roles_model)
    depts: Mapped[set["DeptModel"]] = relationship(secondary=auth_user_depts_model)
